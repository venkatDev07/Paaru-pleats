    ...
    <nav className="bg-primary/95 backdrop-blur-sm fixed top-0 left-0 w-full z-50 shadow-lg border-b border-accent/10">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18 py-4">
          <Link
            to="/"
            className="font-heading text-2xl font-semibold text-cream group"
          >
            Paaru's
            <span className="text-gradient-gold group-hover:brightness-110 ms-1">
              Saree Pre-Pleating
            </span>
          </Link>
          ...
          >
            <motion.span
              animate={
                isOpen
                  ? { rotate: 45, y: 7, backgroundColor: "#e3a63e" }
                  : { rotate: 0, y: 0, backgroundColor: "#fdf6ec" }
              }
